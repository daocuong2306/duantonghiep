...
const AddBanner = () => {
    ...
    const uploadButton = (
        <div>
            ...
            <div style={{ marginTop: 8 }}>Chỉnh sửa ảnh</div>
        </div>
    );
            ...
            <div>
                <div className="col-span-2">
                    <form onSubmit={handleSubmit(onHandleSubmit)}>
                        <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">Thêm nội dung</label>
                        <input
                            type="text"
                            id="name"
                            ...
                            {...register('content')}
                        />
                        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Thêm ảnh</button>
                    </form>
                </div>
            </div>
        </div>
