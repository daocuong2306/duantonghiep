    ...
    return (
        <div>
            ...
            <div className="flex">
                <div className=" w-1/2  ">
                    <div className='w-11/12 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-5 m-auto'>
                        <p className='font-bold bg-indigo-100 p-2 rounded-t-lg text-xl text-blue-400'>Change Profile</p>
                ...
                <div className="w-1/2 ">
                    <div className='w-11/12 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4 m-auto'>
                        <p className='font-bold bg-indigo-100 p-2 rounded-t-lg text-xl text-blue-400'>Change Password</p>
            ...
            <div className='mt-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4'>
                <p className='font-bold bg-indigo-100 p-2 rounded-t-lg text-xl text-blue-400'>Basic Infor</p>
                    ...
                    <div className='w-1/2'>
                        <div className='w-11/12'>
                            <div className="relative z-0 w-full mb-6 group">
                                ...
                                <label className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name Shop</label>
                            </div>
                            <div className="relative z-0 w-full mb-6 group">
                                <input className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div className='mt-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4'>
                <p className='font-bold bg-indigo-100 p-2 rounded-t-lg text-xl text-blue-400'>On Web</p>
                <div className='flex rounded-b-lg bg-slate-100 p-5' >
                    <div className='w-1/2'>
