            ...
            <section className="relative bg-[url(https://lavendermedia.vn/wp-content/uploads/2019/04/word-image-11.png)] bg-cover bg-center bg-no-repeat">
                <div className="p-8 md:p-12 lg:px-16 lg:py-24">
                    <div className="mx-auto max-w-lg text-center">
                        <h2 className="text-2xl font-bold text-[#00ccff] md:text-3xl">
                    ...
                    <div className="mx-auto mt-8 max-w-xl">
                        <form action="#" className="sm:flex sm:gap-4">
                            ...
                            <button
                                type="submit"
                                className="group mt-4 flex w-full items-center justify-center gap-2 rounded-md bg-[#00ccff] px-5 py-3 text-white transition focus:outline-none focus:ring focus:ring-yellow-400 sm:mt-0 sm:w-auto"
                            >
