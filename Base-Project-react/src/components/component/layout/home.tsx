                            ...
                            <div id="header-carousel" className="carousel slide" data-ride="carousel">
                                <div className="carousel-inner">
                                    <div className="carousel-item active" >
                                        <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/carousel-1.jpg" alt="Image" />
                                    ...
                                    <div className="carousel-item" >
                                        <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/carousel-2.jpg" alt="Image" />
                                        <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                            <div className="p-3" >
                                                <h4 className="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4>
                    ...
                    <div className="row px-xl-5 pb-3">
                        <div className="col-lg-4 col-md-6 pb-1">
                            <div className="cat-item d-flex flex-column border mb-4" >
                                ...
                                <a href="" className="cat-img position-relative overflow-hidden mb-3">
                                    <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/cat-1.jpg" alt="" />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 pb-1">
                            <div className="cat-item d-flex flex-column border mb-4" >
                                <p className="text-right">15 Products</p>
                                <a href="" className="cat-img position-relative overflow-hidden mb-3">
                                    <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/cat-2.jpg" alt="" />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 pb-1">
                            <div className="cat-item d-flex flex-column border mb-4" >
                                <p className="text-right">15 Products</p>
                                <a href="" className="cat-img position-relative overflow-hidden mb-3">
                                    <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/cat-3.jpg" alt="" />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 pb-1">
                            <div className="cat-item d-flex flex-column border mb-4">
                                <p className="text-right">15 Products</p>
                                <a href="" className="cat-img position-relative overflow-hidden mb-3">
                                    <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/cat-4.jpg" alt="" />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 pb-1">
                            <div className="cat-item d-flex flex-column border mb-4" >
                                <p className="text-right">15 Products</p>
                                <a href="" className="cat-img position-relative overflow-hidden mb-3">
                                    <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/cat-5.jpg" alt="" />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 pb-1">
                            <div className="cat-item d-flex flex-column border mb-4" >
                                <p className="text-right">15 Products</p>
                                <a href="" className="cat-img position-relative overflow-hidden mb-3">
                                    <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/cat-6.jpg" alt="" />
                                </a>
                ...
                <div className="container-fluid bg-secondary text-dark mt-5 pt-5">
                    ...
                    <div className="row border-top border-light mx-xl-5 py-4">
                        ...
                        <div className="col-md-6 px-xl-0 text-center text-md-right">
                            <img className="img-fluid" src="https://themewagon.github.io/eshopper/img/payments.png" alt="" />
                        </div>
                    </div>
                </div>
