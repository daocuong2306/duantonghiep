...
const product = {
    ...
    colors: [
        { name: 'Trắng', class: 'bg-white', selectedClass: 'ring-gray-400' },
        { name: 'Xám', class: 'bg-gray-200', selectedClass: 'ring-gray-400' },
        { name: 'Đen', class: 'bg-gray-900', selectedClass: 'ring-gray-900' },
    ],
    sizes: [
